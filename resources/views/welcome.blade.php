        ...
        <nav id="my-nav1" class="navbar navbar-expand-lg navbar-light bg-light stroke navbar-light-vision">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent1">
                    ...
                    <a class="btn btn-primary rounded-pill navbar-btn" data-toggle="modal" data-target=".modal">Apply
                        Now</a>
                </div>
        ...
        <div class="outer-window">
            <div class="navbar-content">
                ...
                <nav class="navbar1">
                    ...
                    <a href="#background-carousal"><img src="education/img/logo-img.png" alt="logo"
                            class="logo-small-nav default"></a>
                    <ul class="navbar-nav">
                        <li class="nav-item">
                                ...
                                <div class="row content-carousal">
                                    ...
                                    <div class="col-sm-12 col-lg-6 d-flex justify-content-center align-items-center">
                                        <div class="row margin-top-sm">
                                            ...
                                            <div class="col-6 mini-slider p-0">
                                                ...
                                                <div id="carouselExampleSlidesOnly" class="carousel slide image-div"
                                                    data-ride="carousel">
                                                    <div class="carousel-inner">
                                                        <div class="carousel-item active">
                                                            <img class="d-block w-100" src="education/img/box-img-1.png"
                                                                alt="First slide">
                                                        </div>
                                                        <div class="carousel-item animation1">
                                                            <img class="d-block w-100" src="education/img/box-img-2.png"
                                                                alt="Second slide">
                                                        </div>
                                                        <div class="carousel-item animation2">
                                                            <img class="d-block w-100" src="education/img/box-img-3.png"
                                                                alt="Second slide">
                                                        </div>
                                            ...
                                            <div class="col-6 p-0">
                                                <a href="" class="text-decoration-none">
                                                    <div class="custom-box bg-green-color">
                                                        ...
                                                        <h1
                                                            class="box-text mb-sm-2 mt-sm-2 mb-md-3 mt-md-3 mb-lg-3 mt-lg-3">
                                                            Check Latest Courses</h1>
                                                        <div class="arrow-box">
                                    ...
                                    <div
                                        ...
                                        <div class="detail-sec">
                                            ...
                                            <p class="sub-heading margin-sub-heading">Lorem ipsum dolor sit amet,
                                                consectetur adipi elit, sed do eiusmod tempor incididunt ut
                                                labore et dolore magna aliqua. Ut enim veniam, quis nostrud exercitation
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-lg-8 offset-lg-2 text-center">
                    ...
                    <p class="sub-heading text-black">Lorem ipsum dolor sit amet, consectetur adipi elit, sed do eiusmod
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-height-features">
                    <div class="card box text-center">
                        <div class="card-body box__image">
                            ...
                            <p class="card-text sub-heading">Lorem ipsum dolor sit amet, adipi elit et dolore magna, sed
                                do incididunt</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="admission-text">
                        ...
                        <a class="btn btn-primary rounded-pill blue-btn" data-toggle="modal" data-target=".modal">Apply
                            Now</a>
                    </div>
                </div>
            </div>
            ...
            <div id="js-grid-mosaic" class="cbp cbp-l-grid-mosaic">
                ...
                <div class="cbp-item">
                    <div class="demo height2">
                        <figure class="imghvr-blocks-rotate-right"><img class="img-responsive"
                                src="education/img/portfolio1.png" alt="">
                            <figcaption>
                                <p class="heart-icon"><i class="lni-heart"></i></p>
                                <p>Campus Life</p>
                                <a data-fancybox="gallery1" href="education/img/portfolio1.png"></a>
                            </figcaption>
                        </figure>
                    </div>
                </div>
                ...
                <div class="cbp-item">
                    <div class="demo height2">
                        <figure class="imghvr-blocks-rotate-right"> <img class="img-responsive"
                                src="education/img/portfolio2.png" alt="">

                            <figcaption>
                                <p>Campus Life</p>
                                <a data-fancybox="gallery1" href="education/img/portfolio2.png"></a>
                            </figcaption>
                        </figure>
                    </div>
                </div>
                ...
                <div class="cbp-item">
                    <div class="cbp-caption-defaultWrap">
                        <img src="education/img/portfolio3.png" alt="">
                    </div>
                ...
                <div class="cbp-item">
                    <div class="demo height1">
                        <figure class="imghvr-blocks-rotate-right"><img class="img-responsive"
                                src="education/img/portfolio4.png" alt="">

                            <figcaption>
                                <p class="heart-icon"><i class="lni-heart"></i></p>
                                <p>Campus Life</p>
                                <a data-fancybox="gallery1" href="education/img/portfolio4.png"></a>
                            </figcaption>
                        </figure>
                    </div>
                </div>
                ...
                <div class="cbp-item">
                    <div class="demo">
                        <figure class="imghvr-blocks-rotate-right"> <img class="img-responsive"
                                src="education/img/portfolio5.png" alt="">

                            <figcaption>
                                <p>Campus Life</p>
                                <a data-fancybox="gallery1" href="education/img/portfolio5.png"></a>
                            </figcaption>
                        </figure>
                    </div>
                </div>
                ...
                <div class="cbp-item">
                    <div class="demo">
                        <figure class="imghvr-blocks-rotate-right"><img class="img-responsive"
                                src="education/img/portfolio6.png" alt="">

                            <figcaption>
                                <p>Campus Life</p>
                                <a data-fancybox="gallery1" href="education/img/portfolio6.png"></a>
                            </figcaption>
                        </figure>
                    </div>
                </div>
                ...
                <div class="cbp-item">
                    <div class="demo">
                        <figure class="imghvr-blocks-rotate-right"> <img class="img-responsive"
                                src="education/img/portfolio7.png" alt="">

                            <figcaption>
                                <p>Campus Life</p>
                                <a data-fancybox="gallery1" href="education/img/portfolio7.png"></a>
                            </figcaption>
                        </figure>
                    </div>
                </div>
            ...
            <div id="testimonial-carousal" class="owl-carousel owl-theme testimonial-owl pt-5 pb-5 text-center">
                ...
                <div class="item">
                    ...
                    <div class="student-img mt-2">
                        <img src="education/img/student1.png" alt="student img">
                    </div>
                    ...
                    <div class="description">
                        <p class="width-text text-black sub-heading">Lorem ipsum dolor sit amet, consectetur adipi elit,
                ...
                <div class="item">
                    ...
                    <div class="student-img mt-2">
                        <img src="education/img/student2.png" alt="student img">
                    </div>
                    <div class="student-tittle mt-3 mb-3">
                ...
                <div class="item">
                    ...
                    <div class="student-img mt-2">
                        <img src="education/img/student3.png" alt="student img">
                    </div>
                    <div class="student-tittle mt-3 mb-3">
                ...
                <div class="col-12">
                    <div class="owl-carousel owl-theme no-gutters" id="blog-carousal">
                        ...
                        <div class="item blog-item">
                            <div class="blog-img">
                                <img src="education/img/blog3.png" alt="blog img">
                            </div>
                            ...
                            <div class="blog-text">
                                ...
                                <div class="info-blog mb-3">
                                    <a href="education/blog.html" class="text-decoration-none">
                                        <h4 class="blue-color mb-0 mt-1 hover-heading">Annual Festival</h4>
                                    </a>
                                    <p class="green-color sub-heading">by John</p>
                                </div>
                                <div class="blog-description">
                                    <p class="sub-heading text-black">Lorem ipsum dolor sit amet, consectetur adipi
                                        elit, sed do eiusmod tempor incididunt ut. Ut enim veniam,
                                        in voluptate velit esse cillum.</p>
                                </div>
                                <a href="education/blog.html"
                                    class="btn btn-primary rounded-pill navbar-btn mt-4 ml-1">Read More</a>
                            </div>
                        </div>

                        <div class="item blog-item">
                            <div class="blog-img">
                                <img src="education/img/blog1.png" alt="blog img">
                            </div>
                            ...
                            <div class="blog-text">
                                ...
                                <div class="info-blog mb-3">
                                    <a href="education/blog.html" class="text-decoration-none">
                                        <h4 class="blue-color mb-0 mt-1 hover-heading">Graduation Day</h4>
                                    </a>
                        ...
                        <div class="item blog-item">
                            <div class="blog-img">
                                <img src="education/img/blog4.png" alt="blog img">
                            </div>
                            ...
                            <div class="blog-text">
                                ...
                                <div class="info-blog mb-3">
                                    <a href="education/blog.html" class="text-decoration-none">
                                        <h4 class="blue-color mb-0 mt-1 hover-heading">Campus Life</h4>
                                    </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center footer-content">
                    ...
                    <p class="sub-heading footer_text text-black"><i class="far fa-copyright"></i>2020 MegaOne. Made
                        with love by themeindustry</p>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <form class="appointment-form contact-form" id="modal-contact-form-data">
                        ...
                        <h1 class="font-weight-bold green-color form-tittle">Apply<span class="blue-color"> Now!</span>
                        </h1>
                        ...
                        <div class="form-group-1">
                            ...
                            <input type="number" name="userPhone" id="phone_number" placeholder="Phone number"
                                required />
                        ...
                        <button type="submit"
                            ...
                            id="submit_btn"><i class="fa fa-spinner fa-spin mr-2 d-none"
                                aria-hidden="true"></i><b>SUBMIT NOW</b></button>
